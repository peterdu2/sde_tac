...
class escape_time_solver:
    ...
    def __init__(self, d, M, max_degree, pcs_m, pcs_b, pcs_equality, y0, q_alpha_equality, scs_scale, q_alpha=5, max_opt_iters=5000,
    ...
    def solve(self, mode='Maximize'):
        ...
        for i in range(len(self.mj)):
            constraints.append(self.mj[i] >= 0)
    ...
    def exit_measure_equality_constraints(self):
        ...
        max_poly_degree = self.equality_poly_degree
...
if __name__ == '__main__':
    ...
    equality_poly_degree = 2
    # Localising matrix equality constraints
    # # t^2 x^2 - 11 t^2 x + 10 t^2 - 30 T x^2 + 330 T x - 300 T
    ...
    # t x^2 - 11 t x + 10 t - T x^2 + 11 T x - 10 T
    ...
    for order in range(1):
        ets = escape_time_solver(d=state_dim, M=num_moments, max_degree=max_degree, q_alpha=q_polynomial_deg, q_alpha_equality=equality_poly_degree,
                                pcs_m=pcs_m, pcs_b=pcs_b, pcs_equality=pcs_equality, y0=starting_state, scs_scale=scs_scale,
